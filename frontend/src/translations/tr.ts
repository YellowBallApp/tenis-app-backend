export default {
  ...
  reservation: {
    ...
    reservationInvitationSent: 'Rezervasyon daveti gönderildi',
    ...
    accepted: 'Kabul etti',
    waiting: 'Beklemede',
    rejectConfirm: 'Bu rezervasyonu reddedeceksiniz; rezervasyon iptal edilecek. Emin misiniz?',
    rejected: 'Rezervasyon reddedildi ve iptal edildi',
    rejectError: 'Red işlemi başarısız',
    acceptError: 'Kabul işlemi başarısız',
    acceptSuccess: 'Rezervasyon kabul edildi',
  ...
  notifications: {
    ...
    reservationRequest: 'Rezervasyon İsteği',
